...
(() => {
  const DICT = {
    ru: {
      ...
      'works.o4n': 'Вид сбоку',
      'works.o5': 'Преображение улыбки',
      'works.o6': 'Брекет-система с мини-имплантом',
      'works.o7': 'Лечение с опорой на мини-импланты',
      'works.o8': 'Лечение керамическими брекетами',
      'works.o9': 'Улыбка в процессе лечения',
      'works.o10': 'Закрытие промежутков между зубами',
      'works.o11': 'Выравнивание высоко расположенного клыка',
      'works.o12': 'Процесс лечения',
      'works.o13': 'Детская ортодонтия',
      ...
      'works.h7': 'Новая улыбка',
      'works.h8': 'Восстановление эстетики улыбки',
      'works.h9': 'Изменение цвета и формы зубов',
      'works.h10': 'Замена старых коронок',
      'works.h11': 'Эстетичные зубы вместо металлических коронок',
    ...
    en: {
      ...
      'works.o4n': 'Side view',
      'works.o5': 'Smile transformation',
      'works.o6': 'Braces with a mini-implant',
      'works.o7': 'Treatment anchored on mini-implants',
      'works.o8': 'Treatment with ceramic braces',
      'works.o9': 'Smile during treatment',
      'works.o10': 'Closing gaps between teeth',
      'works.o11': 'Aligning a high-positioned canine',
      'works.o12': 'Treatment in progress',
      'works.o13': "Children's orthodontics",
      ...
      'works.a2': 'Condition before treatment',
      ...
      'works.h7': 'A new smile',
      'works.h8': 'Restoring smile aesthetics',
      'works.h9': 'Changing tooth colour and shape',
      'works.h10': 'Replacing old crowns',
      'works.h11': 'Aesthetic teeth instead of metal crowns',
